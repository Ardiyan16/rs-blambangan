...
<!-- Nav Item - Tables -->
			...
			<!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('manajemenpengguna');?>">
                    <i class="fas fa-fw fa-table"></i>
           ...
           <!-- Nav Item - Charts -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('Antrian');?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Antrian</span></a>
            </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Info Pribadi</h6>
                                </div>
                                <div class="card-body">
