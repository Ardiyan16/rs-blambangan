    ...
    <section id="contact" class="contact section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Pendaftaran Pasien Klinik Gigi & Mulut</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form action="<?= base_url('Users/save_pendaftaran7') ?>" method="post" role="form">
                        ...
                        <div class="form-group mt-3">
                            <input type="hidden" class="form-control" readonly name="id_poli" value="7" id="subject" placeholder="Subject">
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'Users/max_klinik_gigimulut'; ?>",
            dataType: 'json',
            method: 'POST',
